...
import { fetchReceivedDocuments } from '@/app/lib/data';
...
export default async function Page(props: {
    ...
    const documents = await fetchReceivedDocuments(searchParams);
    ...
    return (
        <div className="w-full">
            ...
            <div className="space-y-8">
                <DocumentQueryForm type="received" />
                <DocumentTable documents={documents} type="received" />
            </div>
        </div>
    );
}
